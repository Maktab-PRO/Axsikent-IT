...
$("teacherPasswordToggle").addEventListener("click",()=>{const input=$("teacherPassword"),show=input.type==="password";input.type=show?"text":"password";$("teacherPasswordToggle").querySelector(".eye-show").style.display=show?"none":"block";$("teacherPasswordToggle").querySelector(".eye-hide").style.display=show?"block":"none";$("teacherPasswordToggle").setAttribute("aria-label",show?"Parolni yashirish":"Parolni ko‘rsatish")});
