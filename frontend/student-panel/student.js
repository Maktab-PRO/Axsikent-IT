...
async function startStudentOnlineExam(examId, button) {
    ...
    let body = document.getElementById("studentOnlineWindowBody");
    if (!body) {
        openStudentOnlineTests(true);
        body = document.getElementById("studentOnlineWindowBody");
    }
    if (!body) {
        if (button) {
            button.disabled = false;
    ...
    try {
        ...
        const message = error?.name === "AbortError"
            ? "Test serveridan javob kutilgan vaqtda kelmadi. Qayta urinib ko‘ring."
            : "Online testni boshlab bo‘lmadi. Qayta urinib ko‘ring.";
