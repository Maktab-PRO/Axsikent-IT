...
let lang=localStorage.getItem("teacher_lang")||"uz", token=localStorage.getItem("teacher_access_token"), teacher=null, students=[], teacherCourses=[];
